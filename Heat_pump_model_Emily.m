...
h_w_in=refpropm('H','T',T_w,'P',100,'water');%enthalpy of water at evap inlet
h_w_out=refpropm('H','T',T_r,'P',100,'water');%enthalpy of wirter at evap outlet
Q_dotg = m_dot_r*(h_out-h_in);%heat transfer rate into refrigerant and into ground loop from ground
m_dot_w=Q_dotg/(h_w_in-h_w_out);%water mass flow rate
s_w_intoground=refpropm('S','T',T_r,'P',100,'water');
s_w_outofground=refpropm('S','T',T_w,'P',100,'water');
...
%general air
c_pa=1006;%specific heat of water at average temperature (in J/kg-K)
